...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "manufacturersapp/test/integration/FirstJourney",
    "manufacturersapp/test/integration/ManufacturersListJourney",
    "manufacturersapp/test/integration/ManufacturersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
